...
namespace EMPOWER_TALK
{
    ...
    public partial class DlgParams : Form
    {
        ...
        public void AddTrackbar(string name, int id, int min, int max, int tf, int startValue)
        {
            ...
            l.Location =  Point(constSpace, y0);
            l.Size = LABEL_SIZE;
            l.AutoSize = true;
            l.Text = name + ":";
            this.Controls.Add(l);
            ...
            trackBar.Location =  Point(constSpace, y0);
            trackBar.Size = TRACKBAR_SIZE;
            this.Controls.Add(trackBar);

            tb.Location = Point(trackBar.Size.Width + 2 * constSpace, y0 + 15);
            tb.Size = Size(40, tb.Size.Height);
        ...
        private System.Drawing.Size Size(int p1, int p2)
        {
            throw new NotImplementedException();
        }

        private System.Drawing.Point Point(int constSpace, int y0)
        {
            throw new NotImplementedException();
        }
        ...
        public void AddComboBox(string name, int id, string[] values)
        {
            ...
            cBox.Location = Point(constSpace, y0);
        ...
        public void AddButton(string name, System.EventHandler handler)
        {
            ...
            b.Text = name;
            b.Name = name;
            b.Location =  Point(constSpace, y0);
            b.Size = BUTTON_SIZE;
            b.Click += handler;
            this.Controls.Add(b);
        ...
        public void AddCheckBox(string name, int id, bool check)
        {
            ...
            cb.Location =  Point(constSpace, y0);
